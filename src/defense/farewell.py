...
class Farewell(Slide):
    ...
    def construct(self):
        ...
        for sub_dir in ["evelyn", "wedding"]:
            ...
            self.iter_dir(self.people_image_dir, sub_dir=sub_dir, prev_img=prev_img, scale=0.25)

        self.wait(1)
        self.next_slide()

        logo_svg = SVGMobject(str(self.wku_image_dir / "wku" / "wkucupboxline.svg")).scale(2.0)
