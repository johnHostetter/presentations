...
from oral_proposal.conclusion.existing_issues import curr_limitations
from oral_proposal.conclusion.new_horizons import proposed_studies
from oral_proposal.conclusion.plan import proposed_plan
from oral_proposal.methods.clip import CLIPDemo
from oral_proposal.methods.cql import CQLDemo
from oral_proposal.methods.ecm import ECMDemo
from oral_proposal.people.zadeh import Zadeh
from oral_proposal.people.godel import Godel
from oral_proposal.people.einstein import Einstein
from oral_proposal.people.max_black import MaxBlack
from oral_proposal.people.aristotle import Aristotle
from oral_proposal.people.lukasiewicz import Lukasiewicz
from oral_proposal.people.plato import PlatoTheoryOfForms
from oral_proposal.people.bertrand_russell import BertrandRussell
from oral_proposal.introduction.linguistics import define_linguistics
...
def from_zadeh_to_nfn():
    bib_manager = BibTexManager(path=get_project_root() / "oral_proposal" / "ref.bib")
    return [
